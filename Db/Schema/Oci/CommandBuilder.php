...
class CommandBuilder extends \Lib\Db\Schema\CommandBuilder
{
    /**
...
EOD;
     ...
     * @param Schema\TableSchema $table the table schema or the table name (string).
    ...
    public function createInsertCommand($table, $data)
    {
        ...
        foreach ($data as $name => $value) {
            if (($column = $table->getColumn($name)) !== null && ($value !== null || $column->allowNull)) {
                ...
                if ($value instanceof Schema\Expression) {
