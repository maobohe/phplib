...
abstract class Schema
{
    ...
    /**
     * Constructor.
     * @param Db\Connection $conn database connection.
     */
    ...
    /**
     * @return Db\Connection database connection. The connection is active.
     */
     ...
     * @param Schema $table the table schema whose primary key sequence will be reset
    ...
    {
        //此方法需要被子类重载，否则直接抛出异常
        throw new \PDOException(sprintf('类 %s 不支持返回表名.schema' . $schema, get_class($this)));
